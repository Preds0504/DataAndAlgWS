...
public class QuickSorter<E extends Comparable<E>> extends AbstractComparisonSorter<E> {
    ...
    /**
     * the sorting algorithm for quicksort
     */
	@Override
	...
	/**
	 * Helper method for the sorting algorithm
	 * @param data the array
	 * @param low the lowest index
	 * @param high the highest index
	 */
	public void quickSort(E[] data, int low, int high) {
		if (low < high) {
	...
	/**\
	 * The partition part of the algoritm
	 * @param data the array
	 * @param low the first index
	 * @param high the second index
	 * @return the index of the pivot element
	 */
	public int partition(E[] data, int low, int high) {
		int pivotIndex = selector.selectPivot(low, high);
		//Following three lines are a swap
	...
	/**\
	 * The partition helper method
	 * @param data the array
	 * @param low the first index
	 * @param high the second index
	 * @return the new pivot index
	 */
	public int partitionHelper(E[] data, int low, int high) {
		E pivot = data[high];
		int separator = low;
