...
public class ArrayBasedQueue<E> extends AbstractQueue<E> {
    ...
    /**
     * Will add the element to the end of the queue
	...
	/**
	 * Will remove and return the element at the front of queue
	...
	/**
	 * Will return the element at the front of the queue
